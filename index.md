...
> Last updated: 2026-09-24 | Total pages: 55 (channels 11 · entities 15 · concepts 16 · projects 13)
...
- [[channels/branup-design-backup|design-backup]] — 디자인팀: AI/PDF 패키징 파일, 인쇄 검수 (7/28 채널명 변경)
...
- [[projects/홈페이지_hero_페이지_에셋_기획_및_제작|홈페이지 Hero 페이지 에셋 기획 및 제작]] — 대시보드 프로젝트 — 계획
- [[projects/칸겐뷰티_sns_운영|칸겐뷰티 SNS 운영]] — 대시보드 프로젝트 — 계획
- [[projects/kcl_sgs_안정성검사_사업_실행_12_31|KCL SGS 안정성검사 사업 실행(12.31)]] — 대시보드 프로젝트 — 계획
- [[projects/뷰티_bm_채용_프로젝트|뷰티 BM 채용 프로젝트]] — 대시보드 프로젝트 — 진행
- [[projects/브랜업_홈페이지_기획안_작성|브랜업 홈페이지 기획안 작성]] — 대시보드 프로젝트 — 계획
- [[projects/에나지크_발주_시뮬레이터|에나지크 발주 시뮬레이터]] — 대시보드 프로젝트 — 보류
- [[projects/시니어_마케터_채용_프로젝트|시니어 마케터 채용 프로젝트]] — 대시보드 프로젝트 — 계획
...
- [[tsonax|TSonaX]] — 실시간 차트 분석 시스템 (Ashton 개발). 1차 배포 마감 2026-09-23 **경과**(진행중), TSonaX/Toffer 활성 업무 5건
