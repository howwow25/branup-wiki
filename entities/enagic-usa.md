...
> 브랜업의 미국/캐나다/멕시코 시장 핵심 유통 파트너. 2026년 아이젤과의 제조위탁계약은 Enagic USA를 통한 북미 수출이 전제되어 있음.

## 개요

- **회사명:** Enagic USA (에나지크 USA)
- **관계:** 브랜업 제품의 북미 유통사
- **대상 시장:** 미국 (Enagic.US), 캐나다 (Enagic.CA), 멕시코 (준비 중)
- **제품:** 브랜업 화장품 라인 (미국/캐나다 패키지 디자인 확정, 불어 병기 등)

## 주요 사항

### 패키지 디자인 (2026-07-14~07-15 기준)
- **미국 (Enagic.US):** Enagic.US 문안 추가, 후면 고시사항 변경. 6/26자 양산 반영 문안, 7/10 변호사 신규 문안 → 다음 발주분 적용
- **캐나다 (Enagic.CA):** 불어 병기, 캐나다 법령 적용 (글자 크기 미국보다 큼), 미국과 동일 레이아웃. Enagic.CA 문안 추가
- **디자인 확정:** [[branup-design-backup]] 채널에서 인쇄·후가공 최종사항 확정
- **최종 AI 파일 등록 (7/15):**
  - `[확정]0714-1브랜업-미국-표지15300ea.ai` — 미국 표지 인쇄용 최종 파일
  - `[확정]브랜업-캐나다-표지5100ea-0714.ai` — 캐나다 표지 인쇄용 최종 파일
  - `[확정]미국-전면.jpg` / `[확정]캐나다-전면.jpg` — 최종 이미지 확인
  - `[확정]미국-면지.jpg` / `[확정]캐나다-면지.jpg` — 면지 이미지 확인
- **JNJ 자석&명판 타입 샘플 지연 (7/15):** 증착 후가공 업체 여름 휴가 전 물량 밀림으로 샘플 수령 다음주 금요일(7/24) 예상. 원재현 이사 양해 연락

### 인쇄 검토 프로세스 강화 (2026-07-15)
- 대표님 지시: 인쇄 문안 변경 시 최종 후가공 사양, 감리 일정 변경, 다수 원본 파일 수정 필요
...
### 용기 생산 병목 (2026-07-16)
- **문제:** 미국 물량 1.5만세트에 해당하는 용기를 한 번에 생산하기 어려운 상황. 용기 제조사 생산 라인이 Full CAPA.
- **영향:** 9월 중 미국 일부 물량 도착 필요성 대비 일정 리스크
- **대응:** 브랜업은 9월 중 부분 물량이라도 미국 도착이 필요하므로 우선순위 조정 논의 필요
